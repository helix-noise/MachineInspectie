...
using Locatie = MachineInspectie.Controller.Locatie;
...
namespace MachineInspectie
{
    ...
    public sealed partial class Invulscherm : Page
    {
        ...
        #region TestData
        ///TestData
        private List<Model.Locatie> TestList()
        {
            List<Model.Locatie> temp = new List<Model.Locatie>();
            temp.Add(new Model.Locatie(1, 1111, "Locatie1"));
            temp.Add(new Model.Locatie(2, 1222, "Locatie2"));
            temp.Add(new Model.Locatie(3, 1333, "Locatie3"));
            temp.Add(new Model.Locatie(4, 1444, "Locatie4"));
            temp.Add(new Model.Locatie(5, 1555, "Locatie5"));
            temp.Add(new Model.Locatie(6, 1666, "Locatie6"));
            temp.Add(new Model.Locatie(7, 1777, "Locatie7"));
            temp.Add(new Model.Locatie(8, 1888, "Locatie8"));
            return temp;
        }
        ...
        private List<Matis> TestListMatis()
        {
            ...
            temp.Add(new Matis(1, 111, "Matis1", new MatisCategory(1, "MatisCath1"), new Model.Locatie(1, 3366, "Locatie1")));
            temp.Add(new Matis(2, 222, "Matis2", new MatisCategory(2, "MatisCath2"), new Model.Locatie(2, 8899, "Locatie2")));
            temp.Add(new Matis(3, 333, "Matis3", new MatisCategory(3, "MatisCath3"), new Model.Locatie(3, 4561, "Locatie3")));
            temp.Add(new Matis(4, 444, "Matis4", new MatisCategory(4, "MatisCath4"), new Model.Locatie(4, 7851, "Locatie4")));
            temp.Add(new Matis(5, 555, "Matis5", new MatisCategory(5, "MatisCath5"), new Model.Locatie(5, 2564, "Locatie5")));
            return temp;
        }
#endregion
        ...
        {
            Model.Locatie temp = (Model.Locatie)ListPickerLocatie.SelectedItem;
            ...
            ListPickerMatis.DisplayMemberPath = "DisplayNaam";
            if (_taal == "Nl")
            {
